  ...
  return (
    <div id='contact'>
      ...
      <div> 
        ...
        <button style={{display:"flex",alignItems:"center",gap:"20px"}} onClick={() => window.location.href = 'https://www.linkedin.com/in/himanshu-garg-68a972281/'}><img style={{width:"30px"}} src="https://img.icons8.com/ios-filled/50/000000/linkedin.png" alt="linkedin"/> Himanshu Garg</button>
        <button style={{display:"flex",alignItems:"center",gap:"20px"}} onClick={() => window.location.href = 'https://github.com/himanshugarg0007'}><img style={{width:"30px"}} src="https://img.icons8.com/ios-filled/50/000000/github.png" alt="github"/> himanshugarg0007</button>
      </div>
    </div>
  )
}
